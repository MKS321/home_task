            ...
            <div id="accordion">
               ...
               <div class="card card-default">
                  ...
                  <div id="collapse1" class="collapse show">
                     <div class="card-body">
                        <form action="{{route('sub_category-update',['id'=>$data->id])}}" method="post" enctype="multipart/form-data" >
                           @csrf
                           <div class="row">
                              <div class="col-md-3 col-lg-6">
                                 <div class="form-group">
                                   ...
                                   <select class="form-control" name="cat_id">
                                        ...
                                        @foreach($cat as $cat)
                                        <option value="{{$cat->id}}"{{ ($cat->id==$data->cat_id)? "selected" : "" }}>{{$cat->name}}</option>
                                        @endforeach
